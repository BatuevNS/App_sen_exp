...
async function experimentInit() {
  ...
  impass_txt_tr = new visual.TextStim({
    win: psychoJS.window,
    name: 'impass_txt_tr',
    text: 'Ваш процесс решения задачи был прерван в состоянии тупика?',
    font: 'Arial',
    units: undefined, 
...
function inst_tr7RoutineBegin(snapshot) {
  return async function () {
    ...
    inst_tr7Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function tr_2RoutineEachFrame() {
  return async function () {
    ...
    frameRemains = 0.0 + 15.0 - psychoJS.window.monitorFramePeriod * 0.75;// most of one frame period left
    ...
    frameRemains = 0.5 + 14.5 - psychoJS.window.monitorFramePeriod * 0.75;// most of one frame period left
    if (key_resp_7.status === PsychoJS.Status.STARTED && t >= frameRemains) {
      ...
      if (t >= 15.0 && text_slow_tr.status === PsychoJS.Status.NOT_STARTED) {
        // keep track of start time/frame for later
      ...
      frameRemains = 15.0 + 0.8 - psychoJS.window.monitorFramePeriod * 0.75;// most of one frame period left
...
function tr_9RoutineBegin(snapshot) {
    return async function () {
      ...
      tr_9Components.forEach( function(thisComponent) {
        if ('status' in thisComponent)
          thisComponent.status = PsychoJS.Status.NOT_STARTED;
         });
      return Scheduler.Event.NEXT;
...
function tr_10RoutineBegin(snapshot) {
    return async function () {
      ...
      tr_10Components.forEach( function(thisComponent) {
        if ('status' in thisComponent)
          thisComponent.status = PsychoJS.Status.NOT_STARTED;
         });
      return Scheduler.Event.NEXT;
...
function routineRoutineBegin(snapshot) {
    return async function () {
      ...
      routineComponents.forEach( function(thisComponent) {
        if ('status' in thisComponent)
          thisComponent.status = PsychoJS.Status.NOT_STARTED;
         });
      return Scheduler.Event.NEXT;
...
function instr_rep_6RoutineBegin(snapshot) {
    return async function () {
      ...
      instr_rep_6Components.forEach( function(thisComponent) {
        if ('status' in thisComponent)
          thisComponent.status = PsychoJS.Status.NOT_STARTED;
         });
      return Scheduler.Event.NEXT;
...
function exp_2RoutineBegin(snapshot) {
    return async function () {
      ...
      // update component parameters for each repeat
      num_exp.setText((n_trial_exp.toString() + "/49"));
...
function exp_2RoutineEachFrame() {
    return async function () {
      ...
      frameRemains = 15.0 - psychoJS.window.monitorFramePeriod * 0.75;// most of one frame period left
      if ((key_resp_18.status === PsychoJS.Status.STARTED || key_resp_18.status === PsychoJS.Status.FINISHED) && t >= frameRemains) {
        ...
        if (t >= 15.0 && text_slow_exp.status === PsychoJS.Status.NOT_STARTED) {
          // keep track of start time/frame for later
...
function routine_2RoutineBegin(snapshot) {
      return async function () {
        ...
        routine_2Components.forEach( function(thisComponent) {
          if ('status' in thisComponent)
            thisComponent.status = PsychoJS.Status.NOT_STARTED;
           });
        return Scheduler.Event.NEXT;
...
function routine_3RoutineBegin(snapshot) {
      return async function () {
        ...
        routine_3Components.forEach( function(thisComponent) {
          if ('status' in thisComponent)
            thisComponent.status = PsychoJS.Status.NOT_STARTED;
           });
        return Scheduler.Event.NEXT;
...
function routine_4RoutineBegin(snapshot) {
      return async function () {
        ...
        routine_4Components.forEach( function(thisComponent) {
          if ('status' in thisComponent)
            thisComponent.status = PsychoJS.Status.NOT_STARTED;
           });
        return Scheduler.Event.NEXT;
...
function routine_5RoutineBegin(snapshot) {
      return async function () {
        ...
        routine_5Components.forEach( function(thisComponent) {
          if ('status' in thisComponent)
            thisComponent.status = PsychoJS.Status.NOT_STARTED;
           });
        return Scheduler.Event.NEXT;
